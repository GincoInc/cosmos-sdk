	...
	return func(config *Config) {
		config.ModuleConfigs["mint"] = &appv1alpha1.ModuleConfig{
			...
			GolangBindings: []*appv1alpha1.GolangBinding{
				{
					InterfaceType:  "github.com/GincoInc/cosmos-sdk/x/mint/types/types.StakingKeeper",
					Implementation: "github.com/GincoInc/cosmos-sdk/x/staking/keeper/*keeper.Keeper",
				},
			},
		}
	}
