...
import (
	...
	legacybech32 "github.com/GincoInc/cosmos-sdk/types/bech32/legacybech32" //nolint:staticcheck // we do old keys, they're keys after all.
	"github.com/GincoInc/cosmos-sdk/types/errors"
